...
//Satchels
    ...
    class 24th_Druid_Satchel_Medic: OPTRE_ONI_Researcher_Suitcase
    {
		author="Ithias";
		dlc="24th Aux";
		scope=2;
    ...
    class 24th_Druid_Satchel_Large: OPTRE_ONI_Researcher_Suitcase
    {
		author="Ithias";
		dlc="24th Aux";
		scope=2;
    ...
    class 24th_Druid_Satchel_Small: OPTRE_ONI_Researcher_Suitcase
    {
		author="Ithias";
		dlc="24th Aux";
		scope=2;
...
//Invisable
	...
	class 24th_Druid_Rucksack_Basic_Invisable: OPTRE_UNSC_Rucksack
	{
		dlc="24th Aux";
		author="Ithias";
        scope=2;
